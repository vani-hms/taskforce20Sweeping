...
interface TwinbinSidebarProps {
    isVisible: boolean;
    onClose: () => void;
    navigation: any;
}

export default function TwinbinSidebar({ isVisible, onClose, navigation }: TwinbinSidebarProps) {
            ...
            <View style={styles.overlay}>
                ...
                >
                    <View style={styles.header}>
                        <View>
                            <Text style={styles.moduleName}>Twinbin</Text>
                            <Text style={styles.subText}>Litter Bin Management</Text>
                        </View>
                    ...
                    <View style={styles.menuItems}>
                        <MenuItem
                            ...
                            label="Dashboard"
                            onPress={() => navigateTo("TwinbinHome")}
                        />
                        <MenuItem
                            icon={<PlusCircle size={22} color={Colors.primary} />}
                            label="Register Bin"
                            onPress={() => navigateTo("TwinbinRegister")}
                        />
                        <MenuItem
                            icon={<MapPin size={22} color={Colors.primary} />}
                            label="Assigned Bins"
                            onPress={() => navigateTo("TwinbinAssigned")}
                        />
                        <MenuItem
                            icon={<ClipboardList size={22} color={Colors.primary} />}
                            label="My Requests"
                            onPress={() => navigateTo("TwinbinMyRequests")}
                        />
                        <MenuItem
                            icon={<ShieldCheck size={22} color={Colors.primary} />}
                            label="Litter Bins QC"
                            onPress={() => navigateTo("TwinbinQcHome")}
                        />
                        <MenuItem
                            icon={<AlertCircle size={22} color={Colors.primary} />}
                            label="Action Required"
                            onPress={() => navigateTo("TwinbinActionRequired")}
                        />
                    </View>
