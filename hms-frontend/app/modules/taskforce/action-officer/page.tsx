        ...
        <div className="content">
          <header className="flex justify-between items-start mb-8">
            <div>
              ...
              <p className="muted">Review action-required reports and send them back to QC.</p>
            </div>
          ...
          <div className="grid grid-3 gap-4 mb-8">
            ...
            <StatCard label="Returned to QC" value={returnedCount} />
                  ...
                  {loading ? (
                    ...
                    rows.map((r) => (
                      <tr key={r.id} className="border-b border-base-100 hover:bg-base-50">
                        <td className="p-3">
                          <div className="font-medium">{r.feederPoint?.areaName || r.feederPoint?.feederPointName || "-"}</div>
                          <div className="text-xs muted">{r.feederPoint?.locationDescription || "-"}</div>
                        </td>
                        <td className="p-3">
                          <div className="text-xs">{r.feederPoint?.zoneId || "-"}</div>
                          <div className="text-xs muted">{r.feederPoint?.wardId || "-"}</div>
                        </td>
                        <td className="p-3">
