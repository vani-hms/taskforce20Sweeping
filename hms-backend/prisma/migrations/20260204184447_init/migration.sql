-- CreateEnum
CREATE TYPE "SweepingInspectionStatus" AS ENUM ('SUBMITTED', 'APPROVED', 'REJECTED', 'ACTION_REQUIRED', 'ACTION_SUBMITTED', 'REVIEW_PENDING');
...
CREATE TABLE "SweepingInspection" (
    ...
    "latitude" DOUBLE PRECISION NOT NULL,
    "longitude" DOUBLE PRECISION NOT NULL,
    "status" "SweepingInspectionStatus" NOT NULL DEFAULT 'REVIEW_PENDING',
    "qcReviewedById" UUID,
...
CREATE TABLE "InspectionAudit" (
    ...
    "fromStatus" "SweepingInspectionStatus" NOT NULL,
    "toStatus" "SweepingInspectionStatus" NOT NULL,
    "actorId" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "InspectionAudit_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "SweepingInspection_status_cityId_idx" ON "SweepingInspection"("status", "cityId");

-- CreateIndex
CREATE INDEX "SweepingInspection_qcReviewedById_idx" ON "SweepingInspection"("qcReviewedById");

-- CreateIndex
CREATE INDEX "SweepingInspection_createdAt_idx" ON "SweepingInspection"("createdAt");
